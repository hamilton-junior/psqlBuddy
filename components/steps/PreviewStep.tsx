...
const PreviewStep: React.FC<PreviewStepProps> = ({ queryResult, onExecute, onBack, isExecuting, isValidating, validationDisabled, schema }) => {
  ...
  const handleBeautify = () => {
     ...
     const keywords = ['SELECT', 'FROM', 'WHERE', 'LEFT JOIN', 'RIGHT JOIN', 'INNER JOIN', 'JOIN', 'GROUP BY', 'ORDER BY', 'LIMIT', 'HAVING', 'UNION', 'INSERT INTO', 'VALUES', 'UPDATE', 'SET', 'DELETE'];
     keywords.forEach(kw => {
